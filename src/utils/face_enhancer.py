...
def enhancer_generator_no_len(images, method='gfpgan', bg_upsampler='realesrgan'):
    ...
    if MODELS["GFPGANer"] is None:
        ...
        model_path = os.getenv("MODEL_AVATAR_PATH")+"/gfpgan/weights/" + model_name + '.pth'
    ...
    for idx in tqdm(range(len(images)), 'Face Enhancer:'):
        ...
        cropped_faces, restored_faces, r_img = MODELS["GFPGANer"].enhance(
            img,
            has_aligned=False,
