...
def init_path(checkpoint_dir, config_dir, size=512, old_version=False, preprocess='crop'):
    ...
    sadtalker_paths['dir_of_BFM_fitting'] = config_dir # , 'BFM_Fitting'
    sadtalker_paths['audio2pose_yaml_path'] = config_dir+'/auido2pose.yaml'
    sadtalker_paths['audio2exp_yaml_path'] = config_dir+'/auido2exp.yaml'
    ...
    if 'full' in preprocess:
        ...
        sadtalker_paths['facerender_yaml'] = config_dir+'/facerender_still.yaml'
    else:
        sadtalker_paths['mappingnet_checkpoint'] = os.path.join(checkpoint_dir, 'mapping_00229-model.pth.tar')
        sadtalker_paths['facerender_yaml'] = config_dir+'/facerender.yaml'
